<section class="bg-gray-900 text-white py-12 mt-6">
    <div class="container">
        <div class="flex flex-col border-b-2 pb-12 border-gray-400">
            ...
            <div class="flex items-start justify-between py-12">
                ...
                {{-- our company --}}
                <div class="flex flex-col gap-4">
                    <h4 class="font-bold">Our company</h4>
                    <ul class="flex flex-col">
                        <a href="#">Asset Finance</a>
                        <a href="#">Mortgage Broking</a>
                        <a href="#">Compliance</a>
                ...
                {{-- more from us --}}
                <div class="flex flex-col gap-4">
                    <h4 class="font-bold">More from us</h4>
                    <ul class="flex flex-col">
                        <a href="#">Asset Finance</a>
                        <a href="#">Mortgage Broking</a>
                        <a href="#">Compliance</a>
        ...
        <div class="flex flex-col items-center justify-center mt-5">
            ...
            <p class="text-medium font-bold mt-2">Copyright © 2024 Oxcel Broker Services. All rights reserved.</p>
        </div>
    </div>
</section>
